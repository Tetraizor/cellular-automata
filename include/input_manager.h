...
{
public:
    InputManager() : cursor_x(0), cursor_y(0), is_cursor_down(false), is_right_cursor_down(false) {};
    ...
    const bool get_is_right_cursor_down() { return is_right_cursor_down; }
